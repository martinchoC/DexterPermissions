package com.martin.dexterpermissions.activities
...
import com.martin.dexterpermissions.R
import com.martin.dexterpermissions.enums.PermissionStatusEnum
        ...
        Dexter.withActivity(this)
                ...
                .withListener(object: MultiplePermissionsListener {
                    override fun onPermissionsChecked(report: MultiplePermissionsReport?) {
                        report?.let { //si es nulo no entra en el let
    ...
    private fun setPermissionStatus(textView: TextView, status: PermissionStatusEnum) {
        when (status){
            PermissionStatusEnum.GRANTED -> {
                ...
                textView.setTextColor(ContextCompat.getColor(this, R.color.colorPermissionsStatusGranted))
            }
            PermissionStatusEnum.DENIED -> {
                textView.text = getString(R.string.permission_status_denied)
                textView.setTextColor(ContextCompat.getColor(this, R.color.colorPermissionsStatusDenied))
            }
            PermissionStatusEnum.PERMANENTLY_DENIED -> {
                textView.text = getString(R.string.permission_status_denied_permanently)
                textView.setTextColor(ContextCompat.getColor(this, R.color.colorPermissionsStatusPermanentlyDenied))
            }
        }
        ...
        val snackBarPermissionsListener = SnackbarOnDeniedPermissionListener.Builder
                ...
                .withCallback(object: Snackbar.Callback(){
                    ...
                    override fun onDismissed(transientBottomBar: Snackbar?, event: Int) {
                        //Event handler for when the given Snackbar is dismissed
